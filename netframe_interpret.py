...
def main():
    ...
    # stays universal).
    body += netframe_evidence.section_for_state(
        state, netframe_evidence.coverage_days_from_history(HISTORY_FILE))
    ...
    body, _ = netframe_policy.enforce(body, source="interpreter", state=state)
